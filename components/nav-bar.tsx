...
export default function Navbar() {
  ...
  return (
    <NavObserver className="font-recursive sticky top-0 z-99 h-14 border-b bg-white/70 py-3 backdrop-blur-lg">
      <MaxContainerWrap className="flex w-full items-center justify-between border-gray-200 px-2.5 md:mx-auto xl:px-30">
        ...
        <div className="flex items-center justify-center gap-4">
          ...
          <Button className="hidden h-8 items-center justify-center gap-3 bg-green-600 text-xs text-white hover:bg-green-600/90 sm:flex">
            <Link href={"/config/upload"} className="text-center leading-[100%]">
              Create case
            </Link>{" "}
